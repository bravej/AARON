	...
	<body>
		...
		<div id = "corp">
			<div class="row">
				...
				<p>Veuillez saisir le pseudo d'un utilisateur à modérer</p>
			</div><!-- .row -->

			<form action="../../controleur/iAdmin/traitementAdmin.php" method="post">
				<input placeholder="Pseudo" name="Pseudo" type="text"/><br/>

				<input name="Action" value="Rechercher" type="submit"/><br/>
			</form>
			<p>Suprimmer les comptes innactifs ?</p>
			<form action="../../controleur/iAdmin/traitementAdmin.php" method="post">
				<input name="Action" value="Nettoyer" type="submit"/><br/>
			</form>
		</div>
		<footer>
